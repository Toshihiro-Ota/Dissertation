...
Let us begin with a brief review on some generalities of
...
supersymmetry in six dimensions and the whole theory gets independent of the metric
of $C_{g,n}$. Then this higher dimensional
...
%more transparently.
%Another chain of dualities relate these setups to
...
Then, the quantum effect along $S^1_{10}$ creates a curved path around punctures in
$x^6$-$x^{10}$ direction in the original duality frame,
which turns out be the one-cycle $\gamma_{\sigma}$.
