...
%To be inserted the main claim here
  ...
  \centering
    ...
    \begin{tikzpicture}[scale=1, font=\small, baseline=(x.base)]  \node (x) at (0,0) {\vphantom{x}};
      \def\pos{1cm}
        ...
        \draw[semithick, arrows=-to] (B) to node[left,pos=0.5] {(1)} (Q);
        \draw[semithick, dashed, arrows=-to] (B.west) to[bend right=15] node[above left,pos=0.5,align=center,font=\footnotesize] {general \\ prescription} (I);
    ...
    \end{tikzpicture}
    \caption{Structure of section \ref{sec:surface_defects}. (1)}
...
a vertex are of different types, see figure \ref{fig:tiling_checkerboard}.
