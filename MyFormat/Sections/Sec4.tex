...
in table \ref{tab:gauge_ybe} and such a correspondence is called Gauge/YBE correspondence.
...
Holonomy of $\U(1)$ gauge field & Spectral parameter  \tabularnewline  % R-charge
...
and the variants thereof \cite{Gadde:2009kb,Gadde:2011ik,Dimofte:2011ju,Dimofte:2011py,Terashima:2011qi,Terashima:2012cx,Yagi:2013fda,Gadde:2013sca}.
...
We denote the L-operator in this case by $L^{\diamond}$ since
...
%meromorphic functions $f(\zeta)$ as difference operators:
\begin{equation}
...
Let us finally compare the results with the proposal. For clarity of
