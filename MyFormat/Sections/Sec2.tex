...
For the geometric definition of CFT, see e.g. \cite{Friedan:1986ua}. }
%
...
The discussion in this subsection is mainly based on \cite{Yagi:2015lha,Yagi:2016oum}.
...
an assignment of TQFT), usually called S-matrix,
\begin{equation}
    \begin{tikzpicture}[scale=0.6, baseline=(x.base)]
        \node (x) at (0,0) {\vphantom{x}};
