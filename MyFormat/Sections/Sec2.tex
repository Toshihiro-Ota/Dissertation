...
We will give a general statement of the AGT correspondence and apply it to our work
...
Furthermore, both 2d and 3d TQFTs have applications to mirror symmetry,
or topological string theory (see e.g.~\cite{Hori:2003ic}), those have led to fruitful interactions
between physicists and mathematicians. We will take more time for TQFT to
...
states in $\mathcal{H}_{N_{1}}$ and $\mathcal{H}_{N_{2}}$. If
...
The partition function of the Ising model is defined through this energy functional by
\begin{equation}
...
by labels $a,\,b,\,c$ and $d$. The line operators are the world-lines
...
lines. Those involving one or two dashed line,
\begin{equation}
    \begin{tikzpicture}[scale=0.5, baseline=(x.base)]
        \node (x) at (30:2) {};
...
\begin{equation}
    ...
    \quad .
\end{equation}
This diagram shows that the defect acts on the lattice model by another kind of
