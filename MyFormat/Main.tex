...
In this thesis, we investigate a correspondence between
...
The relationship between the brane realization of the correspondence and
the theories of class-$S$ is also considered.
We also explain how our framework can be related to four-dimensional analogue
of Chern-Simons theory by embedding into string theory setup and dualities.
\end{minipage}
\end{abstract}
